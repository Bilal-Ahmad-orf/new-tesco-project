                            ...
                            <ul>
                                <li><a href="#">
                                        <img src="{{ asset('./frontend/assets/images/lang/en.webp') }}" class="mr-3"
                                            alt=""> English</a></li>
                                <li><a href="#">
                                        <img src="{{ asset('./frontend/assets/images/lang/bd.webp') }}" class="mr-3"
                                            alt=""> Bangla</a></li>
                                <li><a href="#">
                                        <img src="{{ asset('./frontend/assets/images/lang/sa.webp') }}" class="mr-3"
                                            alt=""> Arabic</a></li>
                                <li><a href="#">
                                        <img src="{{ asset('./frontend/assets/images/lang/id.webp') }}" class="mr-3"
                                            alt=""> India</a></li>
                ...
                <div class="card border-0 shadow">
                    ...
                    <div class="card-body">
                        ...
                        <div class="left mt-3" style="width: 250px;">
                            ...
                            <div class="border p-3" style="background-color: #fff; border-radius: 6px;">
                                <span style="color: rgb(123, 123, 123); width: fit-content; height: fit-content;">What
                                    can I help you.</span>
                            </div>
                        </div>
