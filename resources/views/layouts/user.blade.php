...
<head>
    ...
    <link rel="stylesheet"
        href="{{ asset('userAssets/assets/bundles/datatables/DataTables-1.10.16/css/dataTables.bootstrap4.min.css') }}">
    ...
    <link rel="apple-touch-icon" sizes="180x180"
        href="{{ asset('userAssets/assets/images/icons/apple-touch-icon.png') }}">
    <link rel="icon" type="image/png" sizes="32x32"
        href="https://tescoglobalmall.com/uploads/all/ditgnb8U3QBFYwagb1KpcHSLyz064XzQr30IQqVI.png">
...
<body>
                ...
                <ul class="navbar-nav navbar-right">
                            ...
                            <div class="dropdown-list-content dropdown-list-message">
                                <a href="#" class="dropdown-item"> <span
                                        class="dropdown-item-avatar
                                            ...
                                            src="{{ asset('userAssets/assets/img/users/user-1.png') }}"
                                        ...
                                        <img alt="image" src="{{ asset('userAssets/assets/img/users/user-2.png') }}"
                                            class="rounded-circle">
                                        ...
                                        class="dropdown-item-avatar text-white">
                                        <img alt="image" src="{{ asset('userAssets/assets/img/users/user-5.png') }}"
                                            class="rounded-circle">
                                        ...
                                        class="dropdown-item-avatar text-white">
                                        <img alt="image"
                                            src="{{ asset('userAssets/assets/img/users/user-4.png') }}"
                                            class="rounded-circle">
                                        ...
                                        class="dropdown-item-avatar text-white">
                                        <img alt="image"
                                            src="{{ asset('userAssets/assets/img/users/user-3.png') }}"
                                            class="rounded-circle">
                                        ...
                                        class="dropdown-item-avatar text-white">
                                        <img alt="image"
                                            src="{{ asset('userAssets/assets/img/users/user-2.png') }}"
                                            class="rounded-circle">
                                    </span> <span class="dropdown-item-desc"> <span class="message-user">Sarah
                    ...
                    <li class="dropdown"><a href="#" data-toggle="dropdown"
                            class="nav-link dropdown-toggle nav-link-lg nav-link-user"> <img alt="image"
                                src="{{ asset('userAssets/assets/img/user.png') }}" class="user-img-radious-style">
                ...
                <aside id="sidebar-wrapper">
                    <div class="sidebar-brand">
                        <a href="index.html"> <img alt="image"
                                src="{{ asset('userAssets/assets/img/tesco_logo.webp') }}" class="header-logo" />
                        </a>
                    </div>
                    <ul class="sidebar-menu">
                        ...
                        <li class="dropdown">
                            <a href="{{ route('seller.purchaseHistory') }}" class="nav-link"><i
                                    data-feather="file-text"></i><span>Purchase History</span></a>
                        </li>

                        <li class="dropdown">
                            <a href="{{ route('seller.refundRequest') }}" class="nav-link"><i
                                    data-feather="arrow-left"></i><span>Send Refund Request</span></a>
                        </li>

                        <li class="dropdown">
                            <a href="{{ route('seller.wishlist') }}" class="nav-link"><i
                                    data-feather="heart"></i><span>Wishlist</span></a>
                        </li>

                        <li class="dropdown">
                            <a href="{{ route('seller.compare') }}" class="nav-link"><i
                                    data-feather="refresh-ccw"></i><span>Compare</span></a>
                        </li>

                        <li class="dropdown">
                            <a href="{{ route('seller.packages') }}" class="nav-link"><i
                                    data-feather="slack"></i><span>Premium Packages</span></a>
                        </li>
              ...
              <a href="products.html" class="nav-link"><i data-feather="shopping-cart"></i><span>Products</span></a>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" style="display: none;">
                                <li><a class="nav-link" href="http://127.0.0.1:8000/admin/products">All Products</a>
                                </li>
                                <li><a class="nav-link" href="http://127.0.0.1:8000/admin/product/add">Add Product</a>
                                </li>
                            </ul>
                        </li>

                        <li class="dropdown">
                            <a href="{{ route('seller.uploadFiles') }}" class="nav-link"><i
                                    data-feather="file-plus"></i><span>Upload Files</span></a>
                        </li>


                        <li class="dropdown">
                            <a href="index.html" class="nav-link"><i
                                    data-feather="volume-2"></i><span>Turntable</span></a>
                        </li>

                        <li class="dropdown">
                            <a href="{{ route('seller.orders') }}" class="nav-link"><i
                                    data-feather="dollar-sign"></i><span>Orders</span></a>
                        </li>

                        <li class="dropdown">
                            <a href="{{ route('seller.recieveRefundRequest') }}" class="nav-link"><i
                                    data-feather="arrow-left"></i><span>Recieved Refund Request</span></a>
                        </li>

                        <li class="dropdown">
                            <a href="{{ route('seller.shopSetting') }}" class="nav-link"><i
                                    data-feather="settings"></i><span>Shop Settings</span></a>
                        </li>

                        <li class="dropdown">
                            <a href="{{ route('seller.affiliate') }}" class="nav-link"><i
                                    data-feather="dollar-sign"></i><span>Affiliat</span></a>
                        </li>

                        <li class="dropdown">
                            <a href="index.html" class="nav-link"><i
                                    data-feather="message-square"></i><span>Conversation</span></a>
                        </li>

                        <li class="dropdown">
                            <a href="{{ route('seller.myWallet') }}" class="nav-link"><i
                                    data-feather="dollar-sign"></i><span>My Wallet</span></a>
                        </li>

                        <li class="dropdown">
                            <a href="{{ route('seller.supportTicket') }}" class="nav-link"><i
                                    data-feather="aperture"></i><span>Support Ticket</span></a>
                        </li>

                        <li class="dropdown">
                            <a href="{{ route('seller.manageProfile') }}" class="nav-link"><i
                                    data-feather="user"></i><span>Manage Profile</span></a>
                        </li>
                    </ul>
                    <hr>
    ...
    <script src="{{ asset('adminAssets/assets/bundles/datatables/DataTables-1.10.16/js/dataTables.bootstrap4.min.js') }}">
    </script>
