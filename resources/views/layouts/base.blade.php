    ...
    <div class="page-wrapper">
                ...
                <div class="container">
                    <div class="header-left">
                        ...
                        <div class="header-dropdown">
                            <a href="#">
                                <img src="{{ asset('./frontend/assets/images/lang/en.webp') }}" class="mr-3"
                                    alt=""> Engligh</a>
                            <div class="header-menu">
                                <ul>
                                    <li><a href="#">
                                            <img src="{{ asset('./frontend/assets/images/lang/en.webp') }}"
                                                class="mr-3" alt=""> English</a></li>
                                    <li><a href="#">
                                            <img src="{{ asset('./frontend/assets/images/lang/bd.webp') }}"
                                                class="mr-3" alt=""> Bangla</a></li>
                                    <li><a href="#">
                                            <img src="{{ asset('./frontend/assets/images/lang/sa.webp') }}"
                                                class="mr-3" alt=""> Arabic</a></li>
                                    <li><a href="#">
                                            <img src="{{ asset('./frontend/assets/images/lang/id.webp') }}"
                                                class="mr-3" alt=""> India</a></li>
                                            ...
                                            <div class="header-dropdown">
                                                ...
                                                <div class="header-menu">
                                                    <ul>
                                                        ...
                                                        <li><a href="{{ route('logout') }}" class="d-block"
                ...
                <div class="container">
                    <div class="header-left">
                        ...
                        <a href="index.html" class="logo">
                            <img src="{{ asset('frontend/assets/images/tesco_logo.webp') }}" alt="tesco Logo"
                                width="220" height="25">
                        </a>
                    </div><!-- End .header-left -->
        ...
        <footer class="footer footer-2">
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-lg-6">
                            <div class="widget widget-about">
                                <img src="{{ asset('frontend/assets/images/tesco_logo.webp') }}" class="footer-logo"
                                    alt="Footer Logo" width="200" height="">
                                <p>Our goal is to provide customers with affordable commodity every day to help them
                                    enjoy a better quality of life and a more relaxed lifestyle.</p>
                        ...
                        <div class="col-sm-4 col-lg-2">
                            <div class="widget">
                                ...
                                <ul class="widget-list">
                                    <li><a href="#">
                                            <b>Address:</b>
                                            Tesco House Ground Floor, Smile Shire Park, Kestrel Way Welwyn Garden City,
                                            AL7 1GA
                                        </a></li>
                                    <li><a href="#">
                                            <b>Phone:</b>
            ...
            <div class="footer-bottom">
                <div class="container">
                    <p class="footer-copyright">© 2023 TescoGlobalMall. All Rights Reserved.</p>
                    ...
                    <div class="social-icons social-icons-color">
                        <img src="{{ asset('./frontend/assets/images/tesco_logo.webp') }}" alt=""
                            width="150">
                    </div><!-- End .soial-icons -->
                </div><!-- End .container -->
        ...
        <!-- chat box starts -->
        <div class="chat_btn p-0"
            style="position: fixed; z-index: 999; right: -50px; margin-top: 55rem; top: 0; border-radius: 6px;">
            <button class="btn open-button" onclick="openForm()"><i class="icon-envelope"
                    style="background-color: #02549F; padding: 2px 10px; color: #fff; font-size: 23px; border-radius: 6px;"></i>
            </button>
                    ...
                    <div class="card border-0 shadow">
                        <div class="card-header p-3">
                            ...
                            <div class="close">
                                ...
                                <a class="cancel" onclick="closeForm()" style="background-color: transparent;"><i
                        ...
                        <div class="card-body">
                            ...
                            <div class="left mt-3" style="width: 250px;">
                                ...
                                <div class="border p-3" style="background-color: #fff; border-radius: 6px;">
                                    <span style="color: #003ba5; font-size: 16px;font-weight: 500;">Hi there~If you
                                        need any assistance, I'm always here.</span>
                                </div>
                            </div>
                            ...
                            <div class="right mt-2" style="text-align: end;">
                                ...
                                <span class="p-3"
                                    style="background-color: #003ba5; color: #fff; width: fit-content; height: fit-content;">I
                                    need Your Help</span>
                            </div>
                            ...
                            <div class="left mt-3" style="width: 250px;">
                                ...
                                <div class="border p-3" style="background-color: #fff; border-radius: 6px;">
                                    <span
                                        style="color: rgb(123, 123, 123); width: fit-content; height: fit-content;">What
                                        can I help you.</span>
                                </div>
                            </div>
                        ...
                        <div class="card-footer p-0">
                            ...
                            <div class="bottom-footer p-2"
                                ...
                                <button class="border-0 text-white"
                                    style="padding: 5px 8px; border-radius: 6px; background-color: #003ba5; font-size: 13px;">Send</button>
                            </div>
                        </div>
                    </div>
                    <!-- <h1>Chat</h1>
    ...
    <div class="mobile-menu-container mobile-menu-light">
        <div class="mobile-menu-wrapper">
            ...
            <ul class="nav nav-pills-mobile nav-border-anim" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="mobile-menu-link" data-toggle="tab" href="#"
                        role="tab" aria-controls="mobile-menu-tab" aria-selected="true">Menu</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="mobile-cats-link" data-toggle="tab" href="#" role="tab"
                            ...
                            <ul class="nav nav-pills nav-fill nav-border-anim" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="signin-tab" data-toggle="tab" href="#signin"
                                        role="tab" aria-controls="signin" aria-selected="true">Login</a>
                                </li>
                                <li class="nav-item">
                ...
                <div class="row no-gutters bg-white newsletter-popup-content">
                    <div class="col-xl-3-5col col-lg-7 banner-content-wrap">
                        <div class="banner-content text-center">
                            <img src="{{ asset('frontend/assets/images/tesco_logo.webp') }}" class="logo"
                                alt="logo" width="120" height="15">
                            <h2 class="banner-title">get <span>25<light>%</light></span> off</h2>
                            <p>Subscribe to the tescoglobalmall eCommerce newsletter to receive timely updates from your
                                favorite products.</p>
                            <form action="#">
